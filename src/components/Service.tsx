  ...
  return (
    <div className='lg:mx-[126px] mx-[50px] '>
        ...
        <div className='lg:w-5/6 text-left mt-6 lg:mt-0'>
            <p className=' font-poppins text-xl sm:text-left text-center'>We’re a hard working, honest team of skilled designers and developers bringing clarity to brands and adding value to their marketing</p>
        </div>
     </div>
     <div className=' mt-10 '>
