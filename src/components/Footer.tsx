    ...
    <div className='md:mx-[50px]  mx-[10px] my-[55px]'>
        ...
        <div className='flex flex-col md:flex-row gap-[40px]'>
             <div>
                ...
                <div className=''>
                <h1 className='footerH'><span className=' font-cocosharp'>Enough about us,<br/> let’s talk about you</span></h1>
                <p className='footerP mt-[30px]'><span className=' font-poppins'>Every new project starts with a<br/> conversation so let’s grab a coffee<br/> and chat</span></p>
                </div>
        </div>
        <div className=' text-right mt-6'>
         <button className='footerBtn'><p className='NavBtnCont text-white '>Let’s Talk</p></button>
        </div>
        </div>  

        <div className='mt-[114px] flex flex-col items-center xl:flex-row justify-between gap-10'>
            <div className=' footerF  flex flex-row sm:gap-[60px] gap-[15px]  xl:text-2xl lg:text-xl sm:text-sm text-[12px] text-left '>
             <div>
                <h1 className='font-poppins font-bold'>©BITDOT</h1>
                <p className='font-poppins'>Privacy policy</p>
             </div>
             <div>
                <h1 className='font-poppins font-bold'>Email</h1>
                <p className='font-poppins'>hello@bitdol.com</p>
             </div>
             <div>
                <h1 className='font-poppins font-bold'>Pakistan</h1>
